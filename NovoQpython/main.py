...
ru = lambda text: text.encode('utf-8', 'ignore')
...
class Server:  
    ...
    def show(self):
        sys.stderr.write(self.about('About').decode('utf-8'))
        time.sleep(1)
        sys.stderr.write(self.config('Configuration').decode('utf-8'))
        time.sleep(2)
        sys.stderr.write(self.log('========Inject Sukses======== \nReading Server:').decode('utf-8'))
